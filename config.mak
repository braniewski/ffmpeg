...
FFMPEG_CONFIG_MAK=1
FFMPEG_CONFIGURATION=--prefix=/usr/local/bin2/ --enable-libmp3lame --enable-libtheora --enable-libx264 --enable-libgsm --enable-postproc --enable-libxvid --enable-pthreads --enable-libvorbis --enable-gpl --enable-x11grab --enable-nonfree --enable-filter=movie --enable-avfilter --enable-libfaac
...
CC_IDENT=gcc 4.7 (Debian 4.7.2-4)
ARCH=x86
CC=gcc
CXX=g++
AS=gcc
...
EXTRALIBS=-ldl -lva -lXfixes -lXext -lX11 -ljack -lasound -lSDL -lxvidcore -lx264 -lvorbisenc -lvorbis -logg -ltheoraenc -ltheoradec -logg -lmp3lame -lgsm -lfaac -lm -pthread -lbz2 -lz -lrt 
COMPAT_OBJS=
EXEOBJS=
INSTALL=install
LIBTARGET=
...
libavfilter_VERSION=3.48.100
libavfilter_VERSION_MAJOR=3
libavfilter_VERSION_MINOR=48
libavformat_VERSION=55.0.100
