...
#define FFMPEG_CONFIGURATION "--prefix=/usr/local/bin2/ --enable-libmp3lame --enable-libtheora --enable-libx264 --enable-libgsm --enable-postproc --enable-libxvid --enable-pthreads --enable-libvorbis --enable-gpl --enable-x11grab --enable-nonfree --enable-filter=movie --enable-avfilter --enable-libfaac"
#define FFMPEG_LICENSE "nonfree and unredistributable"
#define FFMPEG_DATADIR "/usr/local/bin2//share/ffmpeg"
#define AVCONV_DATADIR "/usr/local/bin2//share/ffmpeg"
#define CC_IDENT "gcc 4.7 (Debian 4.7.2-4)"
